...
public class ServerModel {
	 ...
	 * @return The string "" if is successfully save, else the string containing the
	 *         error description
	 * @throws IOException If the connection with the server isnt'active
	 *                     or is interrupted
	 * @throws ClassNotFoundException If unable to find String literal class
	 */
