...
public class Cluster implements Iterable<Integer>, Comparable<Cluster>, Serializable {
	...
	/**
	 * Returns the average distance of the cluster tuples to the cluster centroid
	 * 
	 * @param data Contains the tuples to calculate the distance
	 * @return The average distance
	 */
	double getAvgDistance(Data data) {
